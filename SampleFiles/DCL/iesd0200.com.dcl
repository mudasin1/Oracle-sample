...
$!		P2 - Exclude BTEC NG Level 2 Results
$!		P3 - Exclude BTEC NG Level 3 Results
$!              P4 - Email address to send report to
$!              P5 - Results Pre Visible Days for TEST run
$!
$! Amendment History:
$! -----------------
$! Who  Change Date  Description
$! ---  -----------  -----------
$! CDS  08-SEP-2016  EC2346 : Initial version.
...
$ IF P1 .EQS. "LIVE"
$ THEN
$   source_directory == "ies_live_edifact_resack_outbox"
$   destination == "MERCURY"
$   destination_directory == "/edidata/edifact_results"
$!  EC5824
$   PATH == "edi"
$!  EC5824
...
$   THEN
$     LIVE_OR_TEST == "TEST"
$     source_directory == "ies_test_edifact_resack_outbox"
$     destination == "NT"
$     destination_directory == "edi/smr_edifact_results"
$   ENDIF
$ ELSE
$   source_directory == "ies_test_edifact_resack_outbox"
$   destination == "NT"
...
$   THEN
$     PATH == "dvasa/edi"
$     destination_directory == "dvasa/edi/smr_edifact_results"
$   ELSE
$     IF ENVIRONMENT .EQS. "U"
$     THEN
$       PATH == "uat/edi"
$       destination_directory == "uat/edi/smr_edifact_results"
$     ELSE
$       PATH == "edi"
$       destination_directory == "edi/smr_edifact_results"
$     ENDIF
...
$!
$!  EC5824
$ RESULTS_PREVISIBLE_TESTDAYS = ''P5'
$!  EC5824
$!
...
$!
$ L_OUTFILENAME 	== "iess0200_"+datestring+"_"+timestring+".TXT"
$ L_OUTFILENAME_RENAMED == "iess0200_"+datestring+"_"+timestring+".SENT"
$!
$ OPEN/WRITE TEMPCOM IES_TOP:TEMP_IESD0200.COM
$!
$ WRITE TEMPCOM "$ !! EDIFACT RESULTS PRODUCTION (IESD0200)"
$ WRITE TEMPCOM "$ !! ====================================="
$ WRITE TEMPCOM "$ !!"
$ WRITE TEMPCOM "$ SET VER"
$!  EC5824-Start - A new parameter 'Results Previsible Test Days' is passed
$ write tempcom "$ SQLPLUS abcd/abcd@ORA  @IES_PROGS:IESS0200 ''LIVE_OR_TEST' ''EXCLUDE_L2' ''EXCLUDE_L3' ''DEMAILADDRESSOUT' ''L_OUTFILENAME' ''RESULTS_PREVISIBLE_TESTDAYS'"
$!  EC5824-END
$ WRITE TEMPCOM "$ @ies_top:iesd0230 ''destination' ''source_directory' ''destination_directory' *.*;"
$ WRITE TEMPCOM "$ on error then continue"
$ WRITE TEMPCOM "$ rename/log ''source_directory':*.*; ies_archive"
$ WRITE TEMPCOM "$ OPEN/WRITE TEMPMSG IES_TOP:TEMP_IESD0200.MSG"
...
$ WRITE TEMPCOM "$ WRITE TEMPMSG ""Please find attached the EDIFACT Results Summary Report."""
$ WRITE TEMPCOM "$ WRITE TEMPMSG "" """
$ WRITE TEMPCOM "$ CLOSE TEMPMSG"
$ WRITE TEMPCOM "$ mime"
$ WRITE TEMPCOM "open/draft IES_TOP:TEMP_IESD0200.MSG"
$ WRITE TEMPCOM "add IES_TOP:''l_outfilename'"
$ WRITE TEMPCOM "save"
$ WRITE TEMPCOM "exit"
$ WRITE TEMPCOM "$ MAIL/SUBJECT=""EDIFACT RESULTS SUMMARY REPORT"" -"
$ WRITE TEMPCOM "      IES_TOP:TEMP_IESD0200.MSG SMTP%""''DEMAILADDRESSOUT'"""
...
$ CLOSE TEMPCOM
$!
$ SUBMIT/QUE=OVERNIGHT/NOPRINT/KEEP/LOG=IES_LOGS IES_TOP:TEMP_IESD0200
$!
$ EXIT
